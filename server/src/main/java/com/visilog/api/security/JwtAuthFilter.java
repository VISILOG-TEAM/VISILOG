...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    // Everything else is refused here rather than in each controller,
    // so a new endpoint is gated by default instead of by remembering
    // to gate it: /auth/me and GET /org are what the app needs to
    // render the verify screen at all, and verify-email/
    // resend-verification are the rest of that flow. (POST/PATCH /org
    ...
    private boolean isAllowedWhileRestricted(HttpServletRequest request) {
        ...
        // company's own colors; changing it is not.
