...
// A small, left-aligned corner mark rather than a large centered
// block -- it should read as a brand touch next to the greeting, not
// interrupt the page like a second splash screen.
...
const styles = StyleSheet.create({
  wrap: { alignItems: 'flex-start', marginBottom: spacing.xs },
  frame: {
